    ...
    class Tetrimino
    {
        ...
        public void Soltar()
        {
            ...
            if (HayAlgoDebajo())
            {
                for (int i = 0; i < 4; i++)
                {
                    Program.posicionCaidaPiezaEnGrid[posicion[i][0], posicion[i][1]] = 1;
                }
        ...
        public bool HayAlgoDebajo()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                if (posicion[i][0] + 1 < 23)
                {
                    if (Program.posicionCaidaPiezaEnGrid[posicion[i][0] + 1, posicion[i][1]] == 1)
                    {
                        return true;
                    }
                }
        ...
        public bool? suporponer(List<int[]> location)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (coordenadas.Max() - coordenadas.Min() == 3)
                {
                    ...
                    {
                        if (Program.posicionCaidaPiezaEnGrid[location[i][0], location[i][1]] == 1)
                        {
                            return true;
                        }
                    }
        ...
        public bool HayAlgoIzquierda()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                else if (Program.posicionCaidaPiezaEnGrid[posicion[i][0], posicion[i][1] - 1] == 1)
                {
                    return true;
                }
            }
        ...
        public void Actualizar()
        {
            for (int i = 0; i < 23; i++)
            {
                for (int j = 0; j < 10; j++)
                {
                    Program.areaJuego[i, j] = 0;
                }
            }
            for (int i = 0; i < 4; i++)
            {
                Program.areaJuego[posicion[i][0], posicion[i][1]] = 1;
            }
            Program.Dibujar();
        }
    }
